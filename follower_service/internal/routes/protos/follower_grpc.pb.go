...
type FollowerDBClient interface {
	...
	GetFollowers(ctx context.Context, in *GetFollowersRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Id], error)
...
func (c *followerDBClient) GetFollowers(ctx context.Context, in *GetFollowersRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Id], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &FollowerDB_ServiceDesc.Streams[0], FollowerDB_GetFollowers_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[GetFollowersRequest, Id]{ClientStream: stream}
...
type FollowerDBServer interface {
	...
	GetFollowers(*GetFollowersRequest, grpc.ServerStreamingServer[Id]) error
...
func (UnimplementedFollowerDBServer) GetFollowers(*GetFollowersRequest, grpc.ServerStreamingServer[Id]) error {
...
func _FollowerDB_GetFollowers_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(FollowerDBServer).GetFollowers(m, &grpc.GenericServerStream[GetFollowersRequest, Id]{ServerStream: stream})
}
